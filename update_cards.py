...
variant_order.append("Costco Exclusive")
...
def get_flat_data(cards, rules, sets, aspects):
    ...
    for card in cards:
        ...
        card_info = {
            ...
            "front_image": card_data["artFront"]["data"]["attributes"]["formats"]["card"]["url"] if card_data["artFront"]["data"] is not None and card_data["artFront"]["data"]["attributes"]["formats"]["card"]["url"] != "" else "",
